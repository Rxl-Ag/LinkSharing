            ...
            <div class="d1 mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-5 mt-3">
                                <g:link controller="topic" action="topicshow" params="[tid:resource.topics.id]">${resource.topics.topicName}</g:link>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <g:if test="${(user.admin) || (user.id==user1.id)}">
