<%@ page import="com.rxlogix.Resources; com.rxlogix.Topic" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="row">
        <div class="col-md-7">
            <div class=" c-1 card mb-3">
                ...
                <g:each in="${Resources.list([max:5, sort:"dateCreated", order:"desc"])}" var="val">
                    <div class="row g-0">
                    <div class="col-md-4">
...
%{--                                    <g:link controller="resources" action="postview">View Post</g:link>--}%
            ...
            <div class=" c-1 card mb-3">
                ...
                <g:each in="${Resources.list(max:5)}" var="val">
                <div class="row g-0">
                    <div class="col-md-4">
                        <g:if test="${val.createdBy.userImage}">
                            <asset:image src="${val.createdBy.email}.png" class="img-fluid rounded-start" alt="..." />
