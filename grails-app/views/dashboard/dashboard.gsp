...
<body>
    <nav class="navbar sticky-top nav1">
        ...
        <div class="container col-lg-6">
            ...
            <div class="btn-group">
                    <g:link controller="profile" action="editprofile" type="button" class="btn" style="color: white">
            ...
            <div class="col-md-5">
                ...
                <div class="d2 mb-5">
                    <nav class="navbar navbar-light"  style="padding-top: 0px; padding-bottom: 0px; min-height: 30px">
                        ...
                        <div class="container col-lg-6">
                            <span>
                                <a href="#" style="margin-left: 100px" class="py-0"></a>
                            </span>
                        </div>
                    </nav>
                    <div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <g:link controller="profile" action="userprofile" params="[uid:val.createdBy.id]">${Subscription.countByTopics(Topic.findById(val.topics.id))}</g:link>
                                        </div>
                                        <div class="col-md-3">
                                            <h6 class="text-muted">Posts</h6>
                                            <g:link controller="profile" action="userprofile" params="[uid:val.createdBy.id]">${Resources.countByTopics(Topic.findById(val.topics.id))}</g:link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <g:else>
                        <div class="row" >
                            <div class="col-md-3">
                                <g:if test="${val.topics.createdBy.userImage}">
                                    <asset:image src="${val.topics.createdBy.email}.png" class="img-fluid rounded-start" alt="..." />
                                </g:if>
                                <g:else>
                                    <img src="data:image/jpeg;base64," class="img-fluid rounded-start" alt="...">
                                </g:else>
                ...
                <div class="d2 mb-5">
                    <nav class="navbar navbar-light" style="padding-top: 0px; padding-bottom: 0px; min-height: 30px">
                        ...
                        <g:each in="${topiclist}" var="val">
                            <g:if test="${Topic.findByCreatedByAndId(user,val.id)}">
                                <div class="row">
                                    <div class="col-md-3">
                                        <g:if test="${val.createdBy.userImage}">
                                            <asset:image src="${val.createdBy.email}.png" class="img-fluid rounded-start" alt="..." />
                                    ...
                                    <div class="col-md-9" style="margin-top: 30px">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <g:if test="${Subscription.findByCreatedByAndTopics(user,val)}">
