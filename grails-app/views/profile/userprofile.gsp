<%@ page import="com.rxlogix.Resources; com.rxlogix.Topic; com.rxlogix.Subscription; com.rxlogix.LinkResource" %>
<%--
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="d1 mt-5">
                <div class="row" id="user">
                    <div class="col-md-3">
                        <g:if test="${user1.userImage}">
                            <asset:image src="${user1.id}.png" class="img-fluid rounded-start" alt="..." />
                        </g:if>
                        <g:else>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <b>${Subscription.countByCreatedBy(user1)}</b>
                            </div>
                            <div class="col-md-5">
                                <h6 class="text-muted">Topics</h6>
                                <b>${Topic.countByCreatedBy(user1)}</b>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d1 mb-5">
                ...
                <g:each in="${Topic.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="dropdown col-md-5">
                                        <g:if test="${user==user1 || user.admin}">
                                        ...
                                        <g:else>
                                            ${Subscription.findByTopics(val).seriousness}
                                        </g:else>
                                    </div>
                                    <div class="col-md-7">
                                        <a href="#">
                            ...
                            <div class="col-md-3">
                                ...
                                <b>${Subscription.countByTopics(val)}</b>
                            </div>
                            <div class="col-md-3">
                                <h6 class="text-muted">Post</h6>
                                <b>${Resources.countByTopics(val)}</b>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d1 mb-5">
                ...
                <g:each in="${Subscription.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
                    <div class="col-md-1"></div>
                    <div class="col-md-11">
                        <div class="row mt-4">
        ...
        <div class="col-md-6">
            <div class="styling">
                ...
                <g:each in="${Resources.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <g:link controller="topic" action="topicshow" params="[tid: val.topics.id]">${val.topics.topicName}</g:link>
