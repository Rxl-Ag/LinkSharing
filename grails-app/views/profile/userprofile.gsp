                ...
                <div class="row" id="user">
                    <div class="col-md-3">
                        <g:if test="${user1.userImage}">
                            <asset:image src="${user1.email}.png" class="img-fluid rounded-start" alt="..." />
                        </g:if>
                        <g:else>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="dropdown col-md-5">
                                        <g:if test="${user.id==user1.id || user.admin}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3">
                                <h6 class="text-muted">Subscriptions</h6>
                                <b>${Subscription.countByTopics(val.topics)}</b>
                            </div>
                            <div class="col-md-3">
                                <h6 class="text-muted">Post</h6>
                                <b>${Resources.countByTopics(val.topics)}</b>
                            </div>
                        </div>
                    </div>
                </div>
