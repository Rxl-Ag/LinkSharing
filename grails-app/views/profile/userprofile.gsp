        ...
        <div class="col-md-5">
            <div class="d1 mt-5">
                <div class="row" id="user">
                    ...
                    <div class="col-md-9">
                        <h3>Anurag gupta</h3>
                        <g:link><h5 class="fst-italic">@Anurag</h5></g:link>
                        <div class="row mt-3">
                            <div class="col-md-3">
            ...
            <div class="d1 mb-5">
                <nav class="navbar navbar-light"  style="padding-top: 0px; padding-bottom: 0px; min-height: 30px">
                        <a class="navbar-brand py-0" href="#" style="margin-left: 45%;">Topics</a>
                </nav>
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <g:link controller="topic" action="topicshow" >Grails</g:link>
                                <div class="row">
            ...
            <div class="d1 mb-5">
                <nav class="navbar navbar-light"  style="padding-top: 0px; padding-bottom: 0px; min-height: 30px">
                    <div class="container col-lg-6">
                        <a class="navbar-brand py-0" href="#" style="margin-left: 36%;">Subscriptions</a>
                    </div>
                </nav>
                <div class="row">
                    <div class="col-md-1"></div>
