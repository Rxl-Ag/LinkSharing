<%@ page import="com.rxlogix.LinkResource" %>
<%--
...
<nav class="navbar sticky-top nav1">
    ...
    <div class="container col-lg-4">
        ...
        <a href="#" class="icn" style="margin-left: 100px">
        ...
        <div class="btn-group">
            <g:link controller="dashboard" action="uname" ><button type="button" class="btn" style="color: white">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="d1 mt-5">
                <div class="row" id="user">
                    ...
                    <div class="col-md-9">
                        ...
                        <a href="#"><h5 class="fst-italic">@${user1.username}</h5></a>
                        <div class="row mt-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <b>${com.rxlogix.Subscription.countByCreatedBy(user1)}</b>
                            </div>
                            <div class="col-md-5">
                                <h6 class="text-muted">Topics</h6>
                                <b>${com.rxlogix.Topic.countByCreatedBy(user1)}</b>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d1 mb-5">
                ...
                <g:each in="${com.rxlogix.Topic.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
            ...
            <div class="d1 mb-5">
                ...
                <g:each in="${com.rxlogix.Subscription.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
                    <div class="col-md-1"></div>
                    <div class="col-md-11">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3">
                                <h6 class="text-muted">Subscriptions</h6>
                                <b>${com.rxlogix.Subscription.countByTopics(val.topics)}</b>
                            </div>
                            <div class="col-md-3">
                                <h6 class="text-muted">Post</h6>
                                <b>${com.rxlogix.Resources.countByTopics(val.topics)}</b>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="styling">
                ...
                <g:each in="${com.rxlogix.Resources.findAllByCreatedBy(user1)}" var="val">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <g:link controller="topic" action="topicshow" params="[tid: val.topics.id]">${val.topics.topicName}</g:link>
