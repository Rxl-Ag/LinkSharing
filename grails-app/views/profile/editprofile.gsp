                ...
                <div class="d1 mb-5">
                    <div class="row" id="user">
                        ...
                        <div class="col-md-9">
                            ...
                            <h5 class="fst-italic">@${user.username}</h5>
                            <div class="row mt-4">
                                <div class="col-md-3">
                                    <h6 class="text-muted">Subcriptions</h6>
                                    <b>${Subscription.countByCreatedBy(user)}</b>
                                </div>
                                <div class="col-md-9">
                                    <h6 class="text-muted">Topics</h6>
                                    <b>${Topic.countByCreatedBy(user)}</b>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <g:each in="${Topic.findAllByCreatedBy(user)}" var="val">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="#">${Subscription.countByTopics(val)}</a>
                                    </div>
                                    <div class="col-md-3">
                                        <h6 class="text-muted">Topics</h6>
                                        <a href="#">${Topic.countByCreatedBy(user)}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container spacing">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <a href="#">
                                        <svg width="30px" height="30px" style="margin-top: 10px;" viewBox="0 0 16 16" class="bi bi-envelope-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0  1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/>
                                        </svg>
                                    </a>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <a href="#">
                                        <svg width="30px" height="30px" viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-top: 10px;" onclick="edittopic()">
                                            <path d="M9 1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h5v-1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h5v2.5A1.5 1.5 0 0 0 10.5 6H13v2h1V6L9 1z"/>
                                            <path fill-rule="evenodd" d="M13.5 10a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1H13v-1.5a.5.5 0 0 1 .5-.5z"/>
                                            <path fill-rule="evenodd" d="M13 12.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0v-2z"/>
                                        </svg>
        ...
        <div class="col-md-6">
            <div class="d1">
                ...
                <div class="login-form">
                    <g:form controller="profile" action="updateprofile" params="[uid:user.id]">
