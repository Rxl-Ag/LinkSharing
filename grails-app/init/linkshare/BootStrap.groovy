...
class BootStrap {
    ...
    def init = { servletContext ->
        new Users(firstname: "Anurag",lastname: "Gupta",email: "anurag.gupta1@rxlogix.com", username: "anurag123",admin: true, active: true, password: "121212", confirmpassword: "121212", userImage: "anurag.gupta1@rxlogix.com.png" ).save(flush:true)
